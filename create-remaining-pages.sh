...
# Script pour créer les 10 pages ville restantes automatiquement

# Données des villes : nom|slug|prix|delai|hausse
declare -a villes=(
  "Viviers-du-Lac|viviers-du-lac|3400|42|19"
  "Drumettaz-Clarafond|drumettaz-clarafond|3000|46|16"
  "Méry|mery|2900|48|15"
  "Bourdeau|bourdeau|4000|38|23"
  "Saint-Pierre-d'Albigny|saint-pierre-d-albigny|2500|55|12"
  "Montmélian|montmelian|2600|52|13"
  "Chignin|chignin|2700|50|14"
  "Myans|myans|2600|52|13"
  "La Rochette|la-rochette|2400|58|11"
  "Grésy-sur-Aix|gresy-sur-aix|3100|44|17"
)

for ville_data in "${villes[@]}"; do
  IFS='|' read -r nom slug prix delai hausse <<< "$ville_data"
  
  echo "Création de vendre-maison-${slug}.astro..."
  
  cat > "src/pages/vendre-maison-${slug}.astro" << EOFPAGE
---
import Base from '../layouts/Base.astro';
import { Phone, Calculator, MapPin, TrendingUp, Home, Star } from 'lucide-react';

const meta = {
  title: "Vendre une Maison à ${nom} | Estimation Gratuite | Agence de Voglans",
  description: "Vendez votre maison à ${nom} au meilleur prix. Prix par quartier, expertise locale, vente rapide. Estimation gratuite sous 48h !",
  keywords: ["vendre maison ${nom}", "estimation maison ${nom}", "prix maison ${nom}", "agence immobilière ${nom}"]
};
---
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="max-w-5xl mx-auto text-center">
        <div class="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-primary/20 text-primary px-6 py-3 rounded-full text-sm font-semibold shadow-lg mb-8">
          ...
          <span>Expert Immobilier à ${nom}</span>
        </div>
        ...
        <h1 class="text-5xl md:text-6xl lg:text-7xl font-light mb-6 tracking-tight text-foreground leading-[1.1]">
          ...
          <span class="font-semibold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">${nom}</span>
        </h1>

        <p class="text-xl md:text-2xl text-muted max-w-3xl mx-auto leading-relaxed font-light mb-12">
          Notre <span class="text-primary font-medium">connaissance parfaite</span> du marché de ${nom} vous garantit le <span class="text-primary font-medium">meilleur prix</span>.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-primary/10 shadow-lg">
            ...
            <div class="text-sm text-muted font-medium">Prix moyen ${nom}</div>
          </div>
          <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-primary/10 shadow-lg">
      ...
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-16">
          <h2 class="text-4xl md:text-5xl font-light mb-6 text-foreground">
            Prix par <span class="font-semibold text-primary">Quartier</span>
          </h2>
          <p class="text-xl text-muted max-w-3xl mx-auto">Données actualisées 2024 pour ${nom}</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div class="bg-gradient-to-br from-primary/5 to-white rounded-3xl p-8 border border-primary/10 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center gap-3 mb-4">
              ...
              <h3 class="text-xl font-semibold text-foreground">Centre Village</h3>
            </div>
            <div class="space-y-2">
              <div class="text-3xl font-bold text-primary">\$((prix + 100)) €/m²</div>
              <div class="text-sm text-muted">Authentique</div>
              <div class="text-sm text-muted">Délai : \$((delai - 2)) jours</div>
          ...
          <div class="bg-gradient-to-br from-primary/5 to-white rounded-3xl p-8 border border-primary/10 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center gap-3 mb-4">
              ...
              <h3 class="text-xl font-semibold text-foreground">Résidentiel</h3>
            </div>
            <div class="space-y-2">
              <div class="text-3xl font-bold text-primary">\$((prix - 100)) €/m²</div>
              <div class="text-sm text-muted">Calme</div>
              <div class="text-sm text-muted">Délai : \$((delai + 2)) jours</div>
              <div class="inline-flex items-center gap-1 text-xs text-primary mt-2">
                <Home className="w-4 h-4" />
                <span>Familial</span>
          ...
          <div class="bg-gradient-to-br from-primary/5 to-white rounded-3xl p-8 border border-primary/10 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center gap-3 mb-4">
              ...
              <h3 class="text-xl font-semibold text-foreground">Campagne</h3>
            </div>
            <div class="space-y-2">
              <div class="text-3xl font-bold text-primary">\$((prix - 200)) €/m²</div>
              <div class="text-sm text-muted">Nature</div>
              <div class="text-sm text-muted">Délai : \$((delai + 4)) jours</div>
              <div class="inline-flex items-center gap-1 text-xs text-primary mt-2">
          ...
          <div class="bg-gradient-to-br from-primary/5 to-white rounded-3xl p-8 border border-primary/10 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center gap-3 mb-4">
              ...
              <h3 class="text-xl font-semibold text-foreground">Proche Chambéry</h3>
            </div>
            <div class="space-y-2">
              <div class="text-3xl font-bold text-primary">${prix} €/m²</div>
              <div class="text-sm text-muted">Bien desservi</div>
              <div class="text-sm text-muted">Délai : ${delai} jours</div>
              <div class="inline-flex items-center gap-1 text-xs text-primary mt-2">
          ...
          <div class="bg-gradient-to-br from-primary/5 to-white rounded-3xl p-8 border border-primary/10 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center gap-3 mb-4">
              ...
              <h3 class="text-xl font-semibold text-foreground">Pavillonnaire</h3>
            </div>
            <div class="space-y-2">
              <div class="text-3xl font-bold text-primary">\$((prix - 100)) €/m²</div>
              <div class="text-sm text-muted">Jardins</div>
              <div class="text-sm text-muted">Délai : \$((delai + 2)) jours</div>
              <div class="inline-flex items-center gap-1 text-xs text-primary mt-2">
                <Home className="w-4 h-4" />
          ...
          <div class="bg-gradient-to-br from-primary/5 to-white rounded-3xl p-8 border border-primary/10 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center gap-3 mb-4">
              ...
              <h3 class="text-xl font-semibold text-foreground">Colline</h3>
            </div>
            <div class="space-y-2">
              <div class="text-3xl font-bold text-primary">\$((prix + 200)) €/m²</div>
              <div class="text-sm text-muted">Vue</div>
              <div class="text-sm text-muted">Délai : \$((delai - 2)) jours</div>
              <div class="inline-flex items-center gap-1 text-xs text-primary mt-2">
                <Star className="w-4 h-4" />
                <span>Panorama</span>
    ...
    <div class="container mx-auto px-4">
      <div class="max-w-3xl mx-auto">
        <div class="text-center mb-12">
          ...
          <p class="text-xl text-muted">Recevez une estimation précise sous 48h</p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-8 md:p-12 shadow-xl">
          <form class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label class="block text-sm font-medium text-foreground mb-2">Nombre de pièces</label>
    ...
    <div class="container mx-auto px-4">
      <div class="max-w-4xl mx-auto text-center text-white">
        <h2 class="text-4xl md:text-5xl font-light mb-6">
          Expert Immobilier à <span class="font-semibold">${nom}</span>
        </h2>
...
EOFPAGE
  ...
  echo "✅ Page vendre-maison-${slug}.astro créée"
done

echo ""
echo "🎉 Toutes les 10 pages ont été créées avec succès !"
